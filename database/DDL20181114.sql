...
CREATE TABLE MST_DeliveryState(
	CODE CHAR(2) NOT NULL,
	NAME NVARCHAR(255) NOT NULL, 
...
INSERT INTO MST_DeliveryState (CODE, NAME) VALUES('01', N'受付中');
INSERT INTO MST_DeliveryState (CODE, NAME) VALUES('02', N'運送中');
INSERT INTO MST_DeliveryState (CODE, NAME) VALUES('03', N'キャンセル');
...
CREATE TABLE TSN_DeliveryTable(
	...
	PRIMARY KEY(Idx)
	FOREIGN KEY(State) REFERENCES MST_DeliveryState(CODE)
)
