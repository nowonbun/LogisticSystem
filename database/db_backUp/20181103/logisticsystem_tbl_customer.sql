...
CREATE TABLE `tbl_customer` (
  ...
  `customerTax` int(11) DEFAULT '0',
  `customerGrade` int(11) DEFAULT '0',
  ...
  CONSTRAINT `tbl_customer_ibfk_1` FOREIGN KEY (`companycode`) REFERENCES `tbl_companyinfo` (`companycode`) ON DELETE CASCADE
...
-- Dump completed on 2018-11-03 16:35:14
