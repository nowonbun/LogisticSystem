...
DROP TABLE IF EXISTS `tbl_codemaster`;
...
LOCK TABLES `tbl_codemaster` WRITE;
/*!40000 ALTER TABLE `tbl_codemaster` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_codemaster` ENABLE KEYS */;
UNLOCK TABLES;
