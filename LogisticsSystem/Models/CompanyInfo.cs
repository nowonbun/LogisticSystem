...
namespace LogisticsSystem.Models
{
    public class CompanyInfo : AbstractModel
    {
        ...
        private DateTime companyestablishmentdate;
        ...
        {
            get { return companyestablishmentdate; }
            set { companyestablishmentdate = value; }
        }
        public String CompanyEstablishmeniDateString
        {
            get { return companyestablishmentdate.ToString("yyyy-MM-dd"); }
        }
